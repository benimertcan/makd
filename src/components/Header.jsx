import { User, Search, ShoppingCart, Menu, ChevronDown, LogOut } from 'lucide-react';
            ...
            <header className="flex flex-col my-5 min-w-full">
                <div className='flex flex-row place-items-center justify-between mx-8'>
                    ...
                    <div className='flex flex-row gap-3 lg:gap-5 lg:text-primary-blue flex-wrap place-content-end'>
                        ...
                        <Menu className='size-8 hover:size-7' />
                    </div>
                </div>

                <div className="flex flex-col gap-5 text-text-transparent my-20 text-center lg:flex-row lg:place-self-center lg:my-0 lg:-mt-9 lg:mr-20 mobile-menu lg:h5 lg:text-second-text-color">
                    <Link to="/">Home</Link>
