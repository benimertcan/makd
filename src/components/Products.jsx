...
const Products = () => {
    ...
    return (
        <>
            <section className="flex flex-col gap-10 lg:gap-28  w-full p-12 justify-center md:flex-wrap md:flex-row">

               <div className="flex flex-row   place-content-center self-center w-72 p-4 h-56">
                <div className="flex flex-col justify-center gap-3 z-10">
                    ...
                    <img src="/images/caramelCone.png" className="-ml-10 bg-background-light -z-0 size-48"></img>
